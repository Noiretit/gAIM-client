...
class Home extends Component {
  ...
  filterGamesPerGenre() {
    ...
    axios
      .get(`https://api.rawg.io/api/games?dates=2010-01-01,2020-01-01&genres=${genre}&ordering=-rating&parent_platforms=1,2,3,7`)
  ...
  render() {
    ...
    const topGameSelectedGenre = topSelectedGenre.map((videoGame, index) => (
      <div className="topSelectedGenre" key={index} style={{border: "1px solid black"}}>
        <div>
          <img
            style={{ width: "100px", height: "200px" }}
            src={videoGame.background_image}
